...
import DeleteImage from './imageFolder/delete.png';
import editImage from './imageFolder/editing.png';
...
const EditDelete=  (props)=>{
    ...
    const handleDelete = async(e)=>{
        ...
        if(props.isCityPost===true)
        {
            props?.setCityPostList(
                ...
                const parentDocRef = doc(db, `Cities/${props.searchId}`); 
    ...
    return (
        <div className='Edit_Delete'>
            ...
            <img style={{height:'20px' , width:'20px'}} src={editImage}/>
            ...
            <div id='Delete' onClick={handleDelete}>
                <img style={{height:'20px' , width:'20px'}} src={DeleteImage}/>
                    {/* <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
